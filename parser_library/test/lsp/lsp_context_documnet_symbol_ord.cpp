...
{
    document_symbol_list_s outline = a.context().lsp_ctx->document_symbol(opencode_file_name);
    std::string SEC0 = "SEC0", SEC1 = "SEC1", AUX0 = "AUX0", AUX1 = "AUX1",
        AUX2 = "AUX2", AUX3 = "AUX3", E = "E";
    document_symbol_list_s expected = document_symbol_list_s{
        document_symbol_item_s{
            &E,
            document_symbol_kind::EQU,
...
{
    document_symbol_list_s outline = a.context().lsp_ctx->document_symbol(opencode_file_name);
    std::string MAC1 = "MAC1", E1 = "E1", MAC2 = "MAC2", E2 = "E2", AUX1 = "AUX1",
        AUX2 = "AUX2", AUX3 = "AUX3", SEC = "SEC";
    document_symbol_list_s expected =  document_symbol_list_s{
        document_symbol_item_s{
            &MAC2,
            document_symbol_kind::MACRO,
...
{
    document_symbol_list_s outline = a.context().lsp_ctx->document_symbol(opencode_file_name);
    std::string MAC1 = "MAC1", MAC2 = "MAC2", E1 = "E1", E2 = "E2", E3 = "E3",
        AUX1 = "AUX1", AUX2 = "AUX2", AUX3 = "AUX3", AUX4 = "AUX4", SEC1 = "SEC1", SEC2 = "SEC2";
    document_symbol_list_s expected = document_symbol_list_s{
        document_symbol_item_s{
            &E3,
            document_symbol_kind::EQU,
...
{
    document_symbol_list_s outline = a.context().lsp_ctx->document_symbol(opencode_file_name);
    std::string MAC0 = "MAC0", AUX0 = "AUX0", MAC1 = "MAC1", AUX1 = "AUX1", MAC2 = "MAC2", AUX2 = "AUX2",
        SEC0 = "SEC0", SEC1 = "SEC1", E0 = "E0", E1 = "E1", E2 = "E2";
    document_symbol_list_s expected =   document_symbol_list_s{
        document_symbol_item_s{
            &MAC0,
            document_symbol_kind::MACRO,
...
SEC0 DSECT   
    ...
    const static inline std::string macro_file_name1 = "MAC1", macro_file_name2 = "MAC2",
        macro_file_name3 = "MAC3", macro_file_name4 = "MAC4";
    const static inline std::string macro1 = 
R"(     MACRO
     MAC1
SEC1 CSECT
...
E4   EQU  1 
    ...
    class lib_provider_mock : public workspaces::parse_lib_provider
    {
        ...
        {
            return library == macro_file_name1 || library == macro_file_name2 ||
                library == macro_file_name3 || library == macro_file_name4;
        };
...
TEST_F(lsp_context_document_symbol_ord_macro_9, macro_9)
{
    document_symbol_list_s outline = a.context().lsp_ctx->document_symbol(opencode_file_name);
    std::string MAC0 = "MAC0", AUX0 = "AUX0", MAC1 = "MAC1", AUX1 = "AUX1", MAC2 = "MAC2", AUX2 = "AUX2",
        SEC0 = "SEC0", SEC1 = "SEC1", E0 = "E0", E1 = "E1", E2 = "E2", MAC3 = "MAC3", AUX3 = "AUX3",
        E3 = "E3", MAC4 = "MAC4", AUX4 = "AUX4", E4 = "E4";
    document_symbol_list_s expected =  document_symbol_list_s{
        document_symbol_item_s{
            &MAC3,
            document_symbol_kind::MACRO,
...
EM1  EQU  1 
    ...
    class lib_provider_mock : public workspaces::parse_lib_provider
    {
        ...
        bool has_library(const std::string& library, const std::string&) const override
        {
            return library == copyfile_file_name1 || library == copyfile_file_name2 ||
                library == copyfile_file_name3 || library == macro_file_name1;
        };
...
{
    document_symbol_list_s outline = a.context().lsp_ctx->document_symbol(opencode_file_name);
    std::string EM0 = "EM0", AM0 = "AM0", EM1 = "EM1", AM1 = "AM1", 
        EC0 = "EC0", AC0 = "AC0", EC1 = "EC1", AC1 = "AC1",
        EC2 = "EC2", AC2 = "AC2", EC3 = "EC3", AC3 = "AC3",
        COPYFILE1 = "COPYFILE1", COPYFILE2 = "COPYFILE2", COPYFILE3 = "COPYFILE3",
        MAC0 = "MAC0", MAC1 = "MAC1", SEC1 = "SEC1", SEC2 = "SEC2";
    document_symbol_list_s expected = document_symbol_list_s{
        document_symbol_item_s{
            &MAC1,
            document_symbol_kind::MACRO,
